...
class Game:
    ...
    def __init__(self, screen):
        ...
        self.color_picker = {Asteroid: (255, 0, 0),
                             Starship: (0, 255, 0),
                             Booster: (0, 0, 255),
                             Bullet: (255, 255, 0)}
        ...
        if hit != -1:  # Если столкновение есть...
            ...
            if self.boosters_timeouts[booster_type] == 0:
                self.boosters_timeouts[
                    booster_type] = time.time() + BOOSTER_DURATION  # задаём время деактивации через BOOSTER_DURATION секунд
            ...
            # Если бустер активирован (время деактивации больше 0)...
                ...
                self.boosters_timeouts[
                    booster_type] += BOOSTER_DURATION  # увеличиваем время действия на BOOSTER_DURATION секунд
